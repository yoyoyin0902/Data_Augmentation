...
sets = []
classes = ["long","circle","columnar","grip","blade","grasp","hollow","round_grip"]  ##修改为自己的类别
...
def convert_annotation(image_add):
    ...
    in_file = "/home/user/imageTest/tools-master/DataAugForObjectDetection/Annotations2/"        #修改为你自己的输入目录
    out_file = "/home/user/imageTest/tools-master/DataAugForObjectDetection/txt/"  #修改为你自己的输出目录
...
image_adds ="/home/user/imageTest/tools-master/DataAugForObjectDetection/data/Annotations2"       #修改为你自己的训练数据集目录
